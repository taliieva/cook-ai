...
export default function BillingComponent() {
  ...
  const plans = {
    ...
    yearly: { price: 34.99, originalPrice: 215.88, label: 'Annual', billing: '/year', discount: '84% off' }
  };
  ...
  useEffect(() => {
    if (selectedPayment === 'apple') {
      ...
      const isCardValid = holderName.length > 0 && 
  ...
  const handlePayment = () => {
    if (selectedPayment === 'apple') {
      Alert.alert('Apple Pay', 'Apple Pay payment flow would be triggered here');
    } else {
      Alert.alert('Payment', `Payment of $${calculateFinalPrice()} processed successfully!`);
    }
  };
          ...
          <ScrollView style={styles.scrollView} showsVerticalScrollIndicator={false}>
            ...
            <View style={styles.section}>
              ...
              <View style={styles.promoContainer}>
                ...
                />
                <TouchableOpacity 
                  style={[styles.applyButton, { backgroundColor: theme.colors.accent.primary }]}
              ...
              {appliedPromo && (
                <View style={[styles.promoSuccess, { backgroundColor: '#4CAF50' + '20' }]}>
                  <Ionicons name="checkmark-circle" size={16} color="#4CAF50" />
                  <Text style={[styles.promoSuccessText, { color: '#4CAF50' }]}>
                    {appliedPromo.type === 'percentage' ? `${appliedPromo.discount}% discount applied!` : `$${appliedPromo.discount} discount applied!`}
                  </Text>
                </View>
              )}
              
              {promoError && (
                <View style={[styles.promoError, { backgroundColor: '#F44336' + '20' }]}>
            ...
            <View style={styles.section}>
              ...
              <TouchableOpacity 
                style={[styles.planOption, {
                  backgroundColor: selectedPlan === 'monthly' ? theme.colors.accent.primary + '15' : theme.colors.background.secondary,
                  borderColor: selectedPlan === 'monthly' ? theme.colors.accent.primary : theme.colors.border
                }]}
                ...
                <View style={styles.planHeader}>
                  <View>
                    ...
                    <Text style={[styles.planPrice, { color: theme.colors.text.primary }]}>
                      ${plans.monthly.price}{plans.monthly.billing}
                    </Text>
                  </View>
                  <View style={[styles.radioButton, {
                    ...
                    {selectedPlan === 'monthly' && (
                      <View style={[styles.radioButtonInner, { backgroundColor: theme.colors.accent.primary }]} />
                    )}
                  </View>
                </View>
              </TouchableOpacity>
              ...
              <TouchableOpacity 
                style={[styles.planOption, {
                  backgroundColor: selectedPlan === 'yearly' ? theme.colors.accent.primary + '15' : theme.colors.background.secondary,
                  borderColor: selectedPlan === 'yearly' ? theme.colors.accent.primary : theme.colors.border
                }]}
                ...
                <View style={styles.planHeader}>
                  <View>
                    ...
                    <View style={styles.yearlyPricing}>
                      <Text style={[styles.planPrice, { color: theme.colors.text.primary }]}>
                        ${plans.yearly.price}{plans.yearly.billing}
                      </Text>
            ...
            <View style={styles.section}>
              ...
              <TouchableOpacity 
                style={[styles.paymentOption, {
                  backgroundColor: selectedPayment === 'apple' ? theme.colors.accent.primary + '15' : theme.colors.background.secondary,
                  borderColor: selectedPayment === 'apple' ? theme.colors.accent.primary : theme.colors.border
                }]}
              ...
              <TouchableOpacity 
                style={[styles.paymentOption, {
                  backgroundColor: selectedPayment === 'card' ? theme.colors.accent.primary + '15' : theme.colors.background.secondary,
                  borderColor: selectedPayment === 'card' ? theme.colors.accent.primary : theme.colors.border
                }]}
            ...
            {selectedPayment === 'card' && (
              <View style={styles.section}>
                ...
                <TextInput
                  ...
                  onChangeText={(value) => handleCardChange('holderName', value)}
                />
                ...
                <TextInput
                  ...
                  onChangeText={(value) => handleCardChange('billingAddress', value)}
                  multiline
                  numberOfLines={2}
                />
              </View>
            ...
            {/* Price Summary */}
            <View style={[styles.summarySection, { backgroundColor: theme.colors.background.secondary }]}>
              ...
              <View style={styles.summaryRow}>
                ...
                <Text style={[styles.totalValue, { color: theme.colors.accent.primary }]}>
                  ${calculateFinalPrice()}
                </Text>
              </View>
            </View>
