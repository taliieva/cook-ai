...
export const DishLoadingCard: React.FC<Props> = ({
    ...
    return (
        ...
        >
            <View style={[dishCardStyles.dishContent, isLoadingCard && dishCardStyles.blurredContent]}>
                ...
                <View style={dishCardStyles.contentSection}>
                    <View style={dishCardStyles.nameRow}>
                        <Text style={[dishCardStyles.dishName, { color: theme.colors.text.primary }]}>
                    ...
                    <View style={dishCardStyles.calorieRow}>
                        <View style={dishCardStyles.calorieChip}>
                            ...
                            <Text
                                style={[dishCardStyles.calorieText, { color: theme.colors.accent.primary }]}
                            >
                                {dish.calories} cal
                            </Text>
                        </View>
                        ...
                        <View style={dishCardStyles.costContainer}>
                            <View style={dishCardStyles.outdoorCost}>
                                ...
                                <Text style={dishCardStyles.outdoorCostText}>${dish.outdoorCost}</Text>
                            </View>
                    ...
                    <View style={dishCardStyles.metadataRow}>
                        <View style={dishCardStyles.metadataContainer}>
                            ...
                            <Text
                                style={[dishCardStyles.metadataText, { color: theme.colors.text.secondary }]}
                            >
